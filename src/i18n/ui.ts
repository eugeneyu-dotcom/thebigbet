...
export const ui = {
  'zh-tw': {
    ...
    'nav.strategy': '博弈攻略',
    'nav.football': '足球',
    'nav.international': '國際賽事',
    'nav.worldcup': '2026 世界盃',
    'nav.leagues': '五大聯賽',
    'nav.championsLeague': '歐冠',
    'nav.cricket': '板球',
    'strategy.tag': '博弈攻略',
  ...
  en: {
    ...
    'nav.championsLeague': 'Champions League',
    'nav.cricket': 'Cricket',
  ...
  th: {
    ...
    'nav.verification': 'ตรวจสอบผลทำนาย',
    ...
    'nav.football': 'ฟุตบอล',
    'nav.international': 'เกมทีมชาติ',
    'nav.worldcup': 'ฟุตบอลโลก 2026',
    'nav.leagues': '5 ลีกใหญ่',
    'nav.championsLeague': 'แชมเปียนส์ลีก',
  ...
  bn: {
    ...
    'nav.verification': 'পূর্বাভাস যাচাই',
    ...
    'nav.championsLeague': 'চ্যাম্পিয়নস লিগ',
    'nav.cricket': 'ক্রিকেট',
