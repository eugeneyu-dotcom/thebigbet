...
export const ui = {
  'zh-tw': {
    ...
    'bracket.subtitle': '依 FIFA 官方對戰表排列。小組已踢完的對戰位置會直接顯示確定晉級的球隊，其餘位置則顯示對戰資格（例如「E組第一」或「最佳第三名：A/B/C/D/F」），待小組賽結果出爐後才能確定。',
    'bracket.r32': '32強',
    'bracket.r16': '16強',
  ...
  en: {
    ...
    'bracket.subtitle': 'Laid out per FIFA\'s official wallchart. Slots from groups that have already finished show the confirmed team; everything else shows the slot it\'s reserved for (e.g. "Group E Winner" or "Best 3rd: A/B/C/D/F") until the group stage results are in.',
  ...
  th: {
    ...
    'bracket.subtitle': 'จัดตามตารางการแข่งขันทางการของ FIFA ตำแหน่งจากกลุ่มที่แข่งจบแล้วจะแสดงทีมที่ผ่านเข้ารอบจริง ส่วนตำแหน่งอื่นจะแสดงเงื่อนไข (เช่น "กลุ่ม E อันดับ 1" หรือ "อันดับ 3 ที่ดีที่สุด: A/B/C/D/F") จนกว่าผลรอบแบ่งกลุ่มจะออกมา',
